...
- **Confirmed homepage structure:** Hero; About Kampala Nonstop (three approved paragraphs introducing the Uganda-focused platform and local support); Trip Quiz; Themes (**Kampala Energy, Nature Access, Purpose-Led Travel**); Local Knowledge; Template Itineraries; Featured Experiences; **Discover Uganda Your Way**; footer. Themes are navigational/editorial groupings, not data entities.
