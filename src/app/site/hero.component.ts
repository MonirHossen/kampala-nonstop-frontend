    ...
    <section class="relative min-h-[100svh] overflow-hidden bg-ink">
      <div class="absolute inset-0">
        <img
          ...
          width="1920"
          height="1280"
          class="drift h-full w-full object-cover object-center opacity-[0.8]"
        />
        <div class="absolute inset-0 bg-gradient-to-t from-ink via-ink/60 to-ink/30"></div>
        <div class="absolute inset-0 bg-gradient-to-r from-ink/80 via-ink/35 to-transparent"></div>
      </div>

      <div
        class="relative mx-auto flex min-h-[100svh] max-w-[1400px] flex-col justify-end px-5 pb-14 pt-28 sm:px-8 sm:pb-20"
      >
        <div knReveal class="max-w-3xl">
          <div class="flex items-center gap-3">
            <span class="h-px w-10 bg-primary"></span>
            <p class="eyebrow text-ink-foreground/85">Uganda · Culture · Travel · Concierge</p>
          </div>

          <h1 class="display-xl mt-6 text-ink-foreground">
            Discover Kampala
            <span class="mt-1 block text-[0.92em] text-ink-foreground/92">differently.</span>
          </h1>

          <p class="mt-6 max-w-xl text-[1.05rem] leading-relaxed text-ink-foreground/75 sm:text-[1.15rem]">
            Personalised trip planning, local insights, and unforgettable experiences — join the
            waitlist for early access, and enter to win a return flight to Uganda.
          </p>
          ...
          <div class="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              ...
              class="eyebrow inline-flex items-center justify-center bg-primary px-8 py-4 text-primary-foreground transition-transform duration-300 hover:-translate-y-0.5"
            >
              Join the Waitlist
            </a>
            <button
              ...
              class="eyebrow inline-flex items-center justify-center border border-ink-foreground/35 px-8 py-4 text-ink-foreground transition-colors duration-300 hover:border-primary hover:text-primary"
            >
              Experiences
            </button>
          </div>
